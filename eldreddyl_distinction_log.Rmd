...
- Reflection: Today I focused on getting the paper squared away. I'm forcing myself to learn LaTeX, so progres is slow for now. I already had chunks written out in word previously. I have the literature review, theoretical background, data, and methods section done. I had an introduction for my thesis proposal, but my project's topic has shifted since I wrote it originally, so I'm going to go back and rewrite it. 
